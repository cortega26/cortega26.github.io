...
export const siteDocuments: Record<SiteDocumentKey, Record<SiteLocale, SiteDocumentContent>> = {
  ...
  engagement: {
    en: {
      ...
      closing: 'These terms are governed by Chilean law, with disputes subject to the courts of Santiago. Questions about fit, scope, or timeline? A call is the fastest way to get clarity.',
    ...
    es: {
      ...
      closing: 'Estas condiciones se rigen por la legislación chilena, con los tribunales ordinarios de justicia de Santiago como foro competente. ¿Tienes preguntas sobre alcance, encaje o plazos? Una llamada es la forma más rápida de resolverlas.',
