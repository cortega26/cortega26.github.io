      ...
      sections: [
        {
          ...
          items: [
            ...
            'Basic usage analytics: Google Analytics 4 (gtag.js, G-2HK4GHK7GR, cookie_expires: 60*60*24*395 = 34128000s ≈395 days) may receive page-view, event (tt_location/tt_label/tt_status plus coarse lead-funnel params: service_id, service_category, contact_type, cta_location, error_category, error_stage; page identity uses standard GA4 page dimensions), and browser metadata for aggregate traffic reporting. GA4 sets cookies _ga/_ga_* (395 days, see Cookie Notice). No form contents, messages, or pasted text are ever sent to analytics. Cloudflare Web Analytics (cookieless, aggregate page-load and performance metrics, no cross-site tracking) may also run on the public pages through Cloudflare, which already proxies this site.',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            'Form submissions are delivered by Formspree, meeting scheduling is handled by Calendly, and site analytics are measured with Google Analytics 4 (event-level, G-2HK4GHK7GR).',
      ...
      sections: [
        {
          ...
          items: [
            ...
            'Analítica básica de uso: Google Analytics 4 (gtag.js, G-2HK4GHK7GR, cookie_expires: 60*60*24*395 = 34128000s ≈395 días) puede recibir vistas de página, eventos (tt_location/tt_label/tt_status más parámetros gruesos del funnel: service_id, service_category, contact_type, cta_location, error_category, error_stage; la página se identifica con las dimensiones estándar de GA4) y metadatos del navegador para reportes agregados. GA4 usa cookies _ga/_ga_* (395 días, ver Aviso de Cookies). El contenido de formularios, mensajes o texto pegado nunca se envía a analítica. Cloudflare Web Analytics (sin cookies, métricas agregadas de cargas de página y rendimiento, sin seguimiento entre sitios) también puede operar en las páginas públicas a través de Cloudflare, que ya actúa como proxy de este sitio.',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            'Los formularios se entregan con Formspree, la agenda se gestiona con Calendly y la analítica del sitio se mide con Google Analytics 4 (a nivel de evento, G-2HK4GHK7GR).',
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Google Analytics 4 (gtag.js, G-2HK4GHK7GR, cookie_expires: 60*60*24*395 = 34128000s ≈395 days) sets cookies _ga and _ga_* (395 days, ~13 months) to measure pageviews and events (tt_location/tt_label/tt_status plus coarse lead-funnel params: service_id, service_category, contact_type, cta_location, error_category, error_stage; page identity uses standard GA4 page dimensions). API only supports seconds, so months are expressed as deterministic days (395). IP anonymization is enabled by default and Google Signals is off.',
            'Calendly, Formspree, and infrastructure providers may set or access technical browser storage when their services load or when you interact with them.',
    ...
    es: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Google Analytics 4 (gtag.js, G-2HK4GHK7GR, cookie_expires: 60*60*24*395 = 34128000s ≈395 días) fija cookies _ga y _ga_* (395 días, ~13 meses) para medir vistas de página y eventos (tt_location/tt_label/tt_status más parámetros gruesos del funnel: service_id, service_category, contact_type, cta_location, error_category, error_stage; la página se identifica con las dimensiones estándar de GA4). La API solo soporta segundos, por lo que los meses se expresan como días deterministas (395). La anonimización de IP está activa por defecto y Google Signals está desactivado.',
            'Calendly, Formspree y proveedores de infraestructura pueden definir o leer almacenamiento técnico del navegador cuando sus servicios cargan o cuando interactúas con ellos.',
