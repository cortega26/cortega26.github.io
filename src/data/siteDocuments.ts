      ...
      sections: [
        {
          ...
          items: [
            ...
            'Basic usage analytics: Google Analytics 4 (gtag.js, G-2HK4GHK7GR) and Ahrefs Analytics may receive page-view, event (tt_location/tt_label/tt_status), and browser metadata for aggregate traffic reporting. GA4 sets cookies _ga/_ga_* (14 months, see Cookie Notice).',
          ],
        },
        {
      ...
      sections: [
        {
          ...
          items: [
            ...
            'Analítica básica de uso: Google Analytics 4 (gtag.js, G-2HK4GHK7GR) y Ahrefs Analytics pueden recibir vistas de página, eventos (tt_location/tt_label/tt_status) y metadatos del navegador para reportes agregados. GA4 usa cookies _ga/_ga_* (14 meses, ver Aviso de Cookies).',
          ],
        },
        {
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Google Analytics 4 (gtag.js, G-2HK4GHK7GR) sets cookies _ga and _ga_* (14 months) to measure pageviews and events (tt_location/tt_label/tt_status). IP anonymization is enabled by default and Google Signals is off.',
    ...
    es: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Google Analytics 4 (gtag.js, G-2HK4GHK7GR) fija cookies _ga y _ga_* (14 meses) para medir vistas de página y eventos (tt_location/tt_label/tt_status). La anonimización de IP está activa por defecto y Google Signals está desactivado.',
