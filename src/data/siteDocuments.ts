      ...
      sections: [
        {
          ...
          items: [
            ...
            'Basic usage analytics: Google Analytics 4 (gtag.js, G-2HK4GHK7GR, cookie_expires: 60*60*24*395 = 34128000s ≈395 days) may receive page-view, event (tt_location/tt_label/tt_status), and browser metadata for aggregate traffic reporting. GA4 sets cookies _ga/_ga_* (395 days, see Cookie Notice).',
          ],
        },
        {
      ...
      sections: [
        {
          ...
          items: [
            ...
            'Analítica básica de uso: Google Analytics 4 (gtag.js, G-2HK4GHK7GR, cookie_expires: 60*60*24*395 = 34128000s ≈395 días) puede recibir vistas de página, eventos (tt_location/tt_label/tt_status) y metadatos del navegador para reportes agregados. GA4 usa cookies _ga/_ga_* (395 días, ver Aviso de Cookies).',
          ],
        },
        {
