      ...
      sections: [
        {
          ...
          items: [
            ...
            'Analítica básica de uso: Google Analytics 4 (gtag.js, G-2HK4GHK7GR, cookie_expires: 60*60*24*395 = 34128000s ≈395 días) puede recibir vistas de página, eventos (tt_location/tt_label/tt_status más parámetros gruesos del funnel: service_id, service_category, contact_type, cta_location, error_category, error_stage; la página se identifica con las dimensiones estándar de GA4) y metadatos del navegador para reportes agregados. GA4 usa cookies _ga/_ga_* (395 días, ver Aviso de Cookies). El contenido de formularios, mensajes o texto pegado nunca se envía a analítica.',
          ],
        },
        {
